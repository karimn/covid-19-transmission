...
_5) Decrease over time_. Assuming that the virus was seeded in a particular setting and $R_0$ is sufficiently high (as evidenced by some local outbreaks), the lack of subsequent epidemic could be explained by a few competing hypotheses: 
