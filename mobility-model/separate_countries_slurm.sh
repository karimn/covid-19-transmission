...
Rscript run_mob.R $1 ${SLURM_ARRAY_TASK_ID} -i $3 -o "{all_country_codes}_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}_${RUN_SUFFIX}" --hyperparam=separate_hyperparam.yaml --show-script-options --mobility-model=~0+g_residential
