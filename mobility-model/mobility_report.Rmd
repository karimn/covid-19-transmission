...
params:
  ...
  # country_code: FR
  results_file: multi_64658355_mob_results.rds
  fit_file: multi_64658355_mob.RData
  prior_results_file: multi_64885383_prior_results.rds
  prior_fit_file: multi_64885383_prior.RData 
  subnat_hier: false 
...
```{r prior-imputed-cases, fig.width=10, eval=do_prior_predict}
prior_results %>% 
  select(country_code, country_name, country_data) %>% 
  unnest(country_data) %>% 
