...
script_options <- if (interactive()) {
  ...
  docopt::docopt(opt_desc, 'fit sa --hyperparam=test_hyperparam.yaml --include-param-trend --complete-pooling=trend --no-pooling --epidemic-cutoff=3 -o test --adapt-delta=0.99')
